<?php /* Smarty version Smarty-3.0.7, created on 2012-06-02 17:28:23
         compiled from "F:/www/eshop/private/smartytemplates/templates/admin/order.tpl" */ ?>
<?php /*%%SmartyHeaderCode:207914fc9eac78a2cc1-57773756%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '24bf9b29c7f5cdc30d64e4c86e8a9ecb2b21957e' => 
    array (
      0 => 'F:/www/eshop/private/smartytemplates/templates/admin/order.tpl',
      1 => 1338632900,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '207914fc9eac78a2cc1-57773756',
  'function' => 
  array (
  ),
...
" method="post">
    <table width="100%">
        ...
        <tr>
            <td class="ttovar">Информация о клиенте</td>
            <td class="ttovar"><?php echo $_smarty_tpl->getVariable('order')->value->guestInfo;?>
 </td>
        </tr>
        <tr>
...
<h1>Товары</h1>
    ...
    <table width="100%">
        <tr>
            ...
            <td class="ttovar">Тон</td>
            <td class="ttovar">Цена</td>
            <td class="ttovar">Кол-во</td>
        </tr>
...
"/><?php }else{ ?>&nbsp;<?php }?></td>
                ...
                <td class="ttovar"><?php if ($_smarty_tpl->tpl_vars['product']->value['tone']!==0){?><?php echo $_smarty_tpl->getVariable('product')->value['tone']->title;?>
<?php }?></td>
...
" method="post">
    <table width="100%">
        <tr>
            <td width="200" class="ttovar">E-mail для заказов</td>
            <td class="ttovar"><input name="info[email]" value="<?php echo $_smarty_tpl->getVariable('email')->value;?>
"/></td>
        </tr>
    </table>
    <input id="save" name="save" type="submit" value="Сохранить"/>
