        ...
        <tr>
            ...
            {foreach from=$user_list item=user}
                <tr>
                    ...
                    <td class="tedit" ><a href="?page={$page}&action=edit&login={$user.login}">редактировать</a><br /><a href="?page={$page}&action=del&login={$reu.login}" style="color: #830000">удалить</a> </td>
                </tr>
            {/foreach}
        </table>
    {/if}
